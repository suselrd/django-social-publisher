...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'SocialNetworkApp', fields ['social_app']
        db.delete_unique(u'social_publisher_socialnetworkapp', ['social_app_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'SocialNetworkApp', fields ['social_app']
        db.create_unique(u'social_publisher_socialnetworkapp', ['social_app_id'])
    ...
    models = {
        ...
        u'social_publisher.socialnetworkapp': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'social_app': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['socialaccount.SocialApp']"}),
